...
const rpc = new JsonRpc('http://9d37f58e.ngrok.io', {fetch});
...
app.get('/req', function(req, res) {
    api.transact({
        actions: [{
            ...
            name: 'write',
            authorization: [{
                actor: req.param("account"),
                permission: 'active',
        }],
        data: {
            account: req.param("account"),
            t: Number(req.param("t")),
            user: req.param("user"),
            searchkeyword: req.param("searchkeyword"),
            clickkeyword: req.param("clickkeyword"),
            url: req.param("url"),
            up: Number(req.param("up"))
        },
    }]
    }, {
        blocksBehind: 3,
    ...
    console.log("t :" + req.param("t"));
    console.log("user :" + req.param("user"));
    console.log("searchkeyword :" + req.param("searchkeyword"));
    console.log("clickkeyword :" + req.param("clickkeyword"));
    console.log("url :" + req.param("url"));
    console.log("up :" + req.param("up"));
});
